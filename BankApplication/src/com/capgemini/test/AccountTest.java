...
public class AccountTest {
	...
	@Test
	public void whenAmountIsLessThanRequired() throws InsufficientInitialBalanceException{
		Account acct = new Account();
		acct.setAccountNumber(102);
		acct.setAmount(2000);
		when(accountRepository.save(acct)).thenReturn(false);
		assertEquals(acct, accountService.createAccount(102, 2000));
		
	}
	
	@Test
	public void accountNumberIsInvalid(){
